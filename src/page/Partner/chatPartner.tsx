    ...
    <div className="p-10 w-full h-screen">
      <AnimatedPage>
        ...
        <div className="flex justify-end gap-3 m-4 text-white font-semibold">
          <button className="border border-bgBtn bg-bgBtn hover:bg-blue-900 w-32 rounded-lg">
            Previous
          </button>
          <button className="border border-bgBtn bg-bgBtn hover:bg-blue-900 w-32 py-2 rounded-lg">
            Next
          </button>
        </div>
